 ...
 * @author celio
 */
public final class entradaProduto extends JPanel{
    ...
    public entradaProduto(){
            ...
            JLabel tela = new JLabel("... :::   Entrada de Produtos   ::: ...");
           ...
           // add(tFormPag);
            ...
            gravar.addActionListener(new ActionListener(){
               public void actionPerformed(ActionEvent e){
                  ...
                  rc.sacar("Débito", valorTexto, "BcoBrasil", "Compra de "+soma+" "+produto.getDescProduto()+"(s)");
                  rp.comprar(produto, novaQtd);
