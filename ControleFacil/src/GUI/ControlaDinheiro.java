 ...
 * @author celio
 */
public class ControlaDinheiro extends JPanel{
    ...
    RepositorioConta rc;
        ...
        public ControlaDinheiro(){
            ...
            JLabel tela = new JLabel("... :::   Controle Dinheiro   ::: ...");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                    try {
                        saldoDoub = rc.sacar("Saque",Principal.formatoParaInserir(tValor.getText()),"Dinheiro", tMotivo.getText());
                    } catch (ParseException ex) {
                        Logger.getLogger(ControlaDinheiro.class.getName()).log(Level.SEVERE, null, ex);
                    }
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.transferir("Dinheiro",saldoDe,banco,saldoPara,Principal.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","Dinheiro - "+tMotivo.getText()+"");
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaDinheiro.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.depositar("Depósito",Principal.formatoParaInserir(tValor.getText()),"Dinheiro", tMotivo.getText());
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaDinheiro.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
