 ...
 * @author celio
 */
public class ControlaBcoBrasil extends JPanel{

    JButton extrato,transferir,depositar, sacar,ok,oksacar,okdepositar,oktransferir,limpar, sair;
    JComboBox destino;
    String contas[]={"","Bradesco","LocaSul","Priscila","Santander","Dinheiro"};
    ...
    RepositorioConta rc;
        ...
        public ControlaBcoBrasil(){

            
            JLabel tela = new JLabel("... :::   Controle Marquinho   ::: ...");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                saldoExtrato.setText("Saldo Atual: R$ "+Principal.paraFormatoDinheiro(rc.saldo("BcoBrasil")));
                tabela = rc.extrato("BcoBrasil");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                    try {
                        saldoDoub = rc.sacar("Saque",Principal.formatoParaInserir(tValor.getText()),"BcoBrasil", tMotivo.getText());
                    } catch (ParseException ex) {
                        Logger.getLogger(ControlaBcoBrasil.class.getName()).log(Level.SEVERE, null, ex);
                    }
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String banco = null;
                rc = new RepositorioConta();
                double saldoDeNum = rc.saldo("BcoBrasil");
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.transferir("BcoBrasil",saldoDe,banco,saldoPara,Principal.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","Marquinho - "+tMotivo.getText()+"");
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaBcoBrasil.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.depositar("Depósito",Principal.formatoParaInserir(tValor.getText()),"BcoBrasil", tMotivo.getText());
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaBcoBrasil.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
