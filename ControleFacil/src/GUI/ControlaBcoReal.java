 ...
 * @author celio
 */
public class ControlaBcoReal extends JPanel{

    JButton extrato,transferir,depositar, sacar,ok,oksacar,okdepositar,oktransferir,limpar, sair;
    JComboBox destino;
    String contas[]={"","Bradesco","Priscila","LocaSul","Marquinho","Dinheiro"};
    ...
    RepositorioConta rc;
        ...
        public ControlaBcoReal(){

            JLabel tela = new JLabel("... :::   Controle Santander   ::: ...");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = rc.saldo("BcoReal");
                saldoExtrato.setText("Saldo Atual: R$ "+Principal.paraFormatoDinheiro(saldoDoub));
                tabela = rc.extrato("BcoReal");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                    try {
                        saldoDoub = rc.sacar("Saque",Principal.formatoParaInserir(tValor.getText()),"BcoReal", tMotivo.getText());
                    } catch (ParseException ex) {
                        Logger.getLogger(ControlaBcoReal.class.getName()).log(Level.SEVERE, null, ex);
                    }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
                JOptionPane.showMessageDialog(null,"Novo saldo é: "+novoSaldo);
                /*ControlaBcoReal cbr = new ControlaBcoReal();
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String banco = null;
                rc = new RepositorioConta();
                double saldoDeNum = rc.saldo("BcoReal");
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.transferir("BcoReal",saldoDe,banco,saldoPara,Principal.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","Banco Santander - "+tMotivo.getText()+"");
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaBcoReal.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.depositar("Depósito",Principal.formatoParaInserir(tValor.getText()),"BcoReal", tMotivo.getText());
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaBcoReal.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
