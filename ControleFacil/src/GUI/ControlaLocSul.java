 ...
 * @author celio
 */
public class ControlaLocSul extends JPanel{

    JButton extrato,transferir,depositar, sacar,ok,oksacar,okdepositar,oktransferir,limpar, sair;
    JComboBox destino;
    String contas[]={"","Priscila","Bradesco","Marquinho","Santander","Dinheiro"};
    ...
    RepositorioConta rc;
        ...
        public ControlaLocSul(){

            
            JLabel tela = new JLabel("... :::   Controle LocaSul   ::: ...");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                saldoExtrato.setText("Saldo Atual: R$ "+Principal.paraFormatoDinheiro(rc.saldo("Locasul")));
                tabela = rc.extrato("Locasul");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                    try {
                        saldoDoub = rc.sacar("Saque",Principal.formatoParaInserir(tValor.getText()),"Locasul", tMotivo.getText());
                    } catch (ParseException ex) {
                        Logger.getLogger(ControlaLocSul.class.getName()).log(Level.SEVERE, null, ex);
                    }
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String banco = null;
                rc = new RepositorioConta();
                double saldoDeNum = rc.saldo("Locasul");
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.transferir("Locasul",saldoDe,banco,saldoPara,Principal.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","LocaSul - "+tMotivo.getText()+"");
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaLocSul.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.depositar("Depósito",Principal.formatoParaInserir(tValor.getText()),"Locasul", tMotivo.getText());
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaLocSul.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
