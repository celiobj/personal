 ...
 * @author celio
 */
public class ControlaPris extends JPanel{

    JButton extrato,transferir,depositar, sacar,ok,oksacar,okdepositar,oktransferir,limpar, sair;
    JComboBox destino;
    String contas[]={"","LocaSul","Bradesco","Marquinho","Santander","Dinheiro"};
    ...
    RepositorioConta rc;
        ...
        public ControlaPris(){
            ...
            JLabel tela = new JLabel("... :::   Controle Priscila   ::: ...");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                saldoExtrato.setText("Saldo Atual: R$ "+Principal.paraFormatoDinheiro(rc.saldo("Pris")));
                tabela = rc.extrato("Pris");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                    try {
                        saldoDoub = rc.sacar("Saque",Principal.formatoParaInserir(tValor.getText()),"Pris", tMotivo.getText());
                    } catch (ParseException ex) {
                        Logger.getLogger(ControlaPris.class.getName()).log(Level.SEVERE, null, ex);
                    }
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String banco = null;
                rc = new RepositorioConta();
                double saldoDeNum = rc.saldo("Pris");
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.transferir("Pris",saldoDe,banco,saldoPara,Principal.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","Priscila - "+tMotivo.getText()+"");
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaPris.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = 0;
                   try {
                       saldoDoub = rc.depositar("Depósito",Principal.formatoParaInserir(tValor.getText()),"Pris", tMotivo.getText());
                   } catch (ParseException ex) {
                       Logger.getLogger(ControlaPris.class.getName()).log(Level.SEVERE, null, ex);
                   }
                String novoSaldo = Principal.paraFormatoDinheiro(saldoDoub);
