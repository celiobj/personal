 ...
 * @author celio
 */
public class ControlaBcoReal extends JFrame{
    ...
    RepositorioConta rc;
        ...
        public ControlaBcoReal(){
            ...
            super("..:: |Gerenciamento da conta do Banco Santander| Controle Financeiro - CRAPS Vs. 3.0 ::..");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                rc = new RepositorioConta();
                double saldoDoub = rc.sacar("Saque",VerificarUsuario.formatoParaInserir(tValor.getText()),"BcoReal", tMotivo.getText());
                BigDecimal saldo = BigDecimal.valueOf(saldoDoub);
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = rc.transferir("BcoReal",saldoDe,banco,saldoPara,VerificarUsuario.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","Banco Santander - "+tMotivo.getText()+"");
                BigDecimal saldo = BigDecimal.valueOf(saldoDoub);
                String novoSaldo = VerificarUsuario.paraFormatoDinheiro(saldo);
                JOptionPane.showMessageDialog(null,"Novo saldo é: "+novoSaldo);
                /*ControlaBcoReal cbr = new ControlaBcoReal();
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                rc = new RepositorioConta();
                double saldoDoub = rc.depositar("Depósito",VerificarUsuario.formatoParaInserir(tValor.getText()),"BcoReal", tMotivo.getText());
                BigDecimal saldo = BigDecimal.valueOf(saldoDoub);
                String novoSaldo = VerificarUsuario.paraFormatoDinheiro(saldo);
                JOptionPane.showMessageDialog(null,"Novo saldo é: "+novoSaldo);
               /* ControlaBcoReal cbr = new ControlaBcoReal();
