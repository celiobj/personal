 ...
 * @author celio
 */
public class ControlaPris extends JFrame{
    ...
    RepositorioConta rc;
        ...
        public ControlaPris(){
            ...
            super("..:: |Gerenciamento da conta Priscila | Controle Financeiro - CRAPS Vs. 3.0 ::..");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                BigDecimal saldo = BigDecimal.valueOf(rc.saldo("Pris"));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                rc = new RepositorioConta();
                double saldoDoub = rc.sacar("Saque",VerificarUsuario.formatoParaInserir(tValor.getText()),"Pris", tMotivo.getText());
           ...
           oktransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double saldoDoub = rc.transferir("Pris",saldoDe,banco,saldoPara,VerificarUsuario.formatoParaInserir(tValor.getText()) ,destino.getSelectedItem().toString()+" - "+tMotivo.getText()+"","Priscila - "+tMotivo.getText()+"");
                BigDecimal saldo = BigDecimal.valueOf(saldoDoub);
                String novoSaldo = VerificarUsuario.paraFormatoDinheiro(saldo);
                JOptionPane.showMessageDialog(null,"Novo saldo é: "+novoSaldo);
               /* ControlaBcoBrasil cbb = new ControlaBcoBrasil();
           ...
           okdepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                rc = new RepositorioConta();
                double saldoDoub = rc.depositar("Depósito",VerificarUsuario.formatoParaInserir(tValor.getText()),"Pris", tMotivo.getText());
                BigDecimal saldo = BigDecimal.valueOf(saldoDoub);
                String novoSaldo = VerificarUsuario.paraFormatoDinheiro(saldo);
                JOptionPane.showMessageDialog(null,"Novo saldo é: "+novoSaldo);
               /* ControlaBcoBrasil cbb = new ControlaBcoBrasil();
